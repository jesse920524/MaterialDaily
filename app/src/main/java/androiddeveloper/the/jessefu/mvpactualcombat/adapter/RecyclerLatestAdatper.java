...
public class RecyclerLatestAdatper extends BaseQuickAdapter<LatestNewsStoryEntity, BaseViewHolder> {
    /**
     ...
     */
    public RecyclerLatestAdatper(int layoutResId, List<LatestNewsStoryEntity> data) {
     ...
     */
    @Override
    protected void convert(BaseViewHolder helper, LatestNewsStoryEntity item) {
